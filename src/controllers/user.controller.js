...
const getUserChannelProfile = asyncHandler(async (req, res) => {
            ...
            res.status(200).json(new ApiResponse(200,channel[0],"User channel fetch successfully"))
})
...
const getWatchHistory=asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(200,user[0].watchHistory,"Watch History  fetch succesfully")
})

export { registerUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, getCurrentUser, updateAccountDetails, updatedUserAvatar, updatedUserCoverImage, getUserChannelProfile ,getWatchHistory}